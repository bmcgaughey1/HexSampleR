...
Because the way the data is included with the HexSampleR package, we can access it directly.
...
Example 3 creates sample points on a regular grid with each point representing 6000 acres. This is the 
